...
Graduate researcher (PhD in Applied Mathematics) at [Dr.Kreso's lab,](https://www.math.uh.edu/~josic/) University of Houston, Texas.<br>
<div style="border: 1px solid #ff831eff; padding: 8px; border-radius: 6px;font-size:14px;">
  <span style="color: #ff831eff;font-size:14px;">On My Desk Right Now :</span>  Computational Neuroscience | Neural Representation | Modelling Neural Circuits .
</div>

      

## <span style="border-bottom: 3px solid #1E90FF; color: black; font-weight: bold;">Research Interests</span>
[Computational Neuroscience](https://en.wikipedia.org/wiki/Computational_neuroscience) , [Random dynamical systems](https://en.wikipedia.org/wiki/Random_dynamical_system) ,  [mathematical finance](https://en.wikipedia.org/wiki/Mathematical_finance) and [Mathematical biology](https://en.wikipedia.org/wiki/Computational_biology). I am currently working on  <span style="color: #5ea08cff ;"> modelling neural circuits and Hodgkin–Huxley equation as a nonlinear dynamical system.</span>   Analyzing its equilibria, stability, and bifurcation behavior underlying neuronal action potentials. Prior to this, I focused on [Limit Order Book Modelling](https://www.5minutefinance.org/concepts/the-limit-order-book) applying stochastic processes and machine learning techniques in financial markets by combining agent‑based simulations, reinforcement learning, and time series models to capture market behavior.

<p style="font-size:16px;">  Computational Neuroscience • Dynamical Systems • Probability • Machine learning • Stochastic models • Statistics • Finance •</p>


## <span style="border-bottom: 3px solid #1E90FF; color: black; font-weight: bold;">Overview</span>
Officially I’m **Abdul Rahman**, a.k.a **Shafiq**, but I often go by **“A.B.” (/eɪ biː/)** (pick yor favorite!). My fascinating world is **Applied Mathematics**, with a strong foundation from my Master’s in Mathematics at the [Indian Institute of Technology Madras (IIT Madras)](https://en.wikipedia.org/wiki/IIT_Madras) (not bragging, but it is India's top institute.) I’m glad to have studied there from 2022 to 2024, and my academic journey has been driven by a deep interest in  **dynamical systems, stochastic analysis, computational biology and mathematical finance**, fields that captivate me for their complexity, randomness, and real-world applications.  

 I am passionate about exploring new mathematical theories, developing computational skills, and contributing meaningfully to both research and teaching in these areas.  

Beyond academics, I have a creative side, reveling in the visual arts through both painting and photography. 
<span style="color: #5ea08cff ;">I also enjoy soccer, chess , fitness and thought-provoking movies, which help me maintain balance and perspective.(Typical Sagittarius traits) 😊:  </span> 
